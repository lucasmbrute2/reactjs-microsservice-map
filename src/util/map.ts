import { RouteExistsError } from "../components/errors/route-exists.error";
...
export class Map {
    ...
    addRoute(
        ...
        if (id in this.routes) throw new RouteExistsError();

        const { currentMarketOptions,  endMarkerOptions} = routeOptions;
